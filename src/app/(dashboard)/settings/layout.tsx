...
import { Radio, Users, Tags, Bell, Building2, KeyRound, Sparkles, BookUser, ListPlus } from 'lucide-react';
...
const tabs = [
  ...
  { href: '/settings/custom-fields', label: 'Campos customizados', icon: ListPlus },
